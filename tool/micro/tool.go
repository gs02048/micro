...
const (
	toolDoc = "https://github.com/gs02048/micro/blob/master/doc/wiki-cn/micro-tool.md"
)
...
func toolAction(c *cli.Context) (err error) {
	if c.NArg() == 0 {
		...
		fmt.Println("执行工具: micro tool demo")
		fmt.Println("安装全部工具: micro tool install all")
		fmt.Println("全部升级: micro tool upgrade all")
		fmt.Println("\n详细文档：", toolDoc)
		return
	}
