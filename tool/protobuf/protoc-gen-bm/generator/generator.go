...
func (t *bm) generateFileHeader(file *descriptor.FileDescriptorProto, pkgName string) {
	...
	if t.filesHandled == 0 {
		...
		if err == nil && comment.Leading != "" {
			...
			t.P("This code was generated with micro/tool/protobuf/protoc-gen-bm ", generator.Version, ".")
			t.P()
...
func (t *bm) generateImports(file *descriptor.FileDescriptorProto) {
	...
	t.P(`	"context"`)
	t.P()
	t.P(`	bm "github.com/gs02048/micro/pkg/net/http/blademaster"`)
	t.P(`	"github.com/gs02048/micro/pkg/net/http/blademaster/binding"`)
