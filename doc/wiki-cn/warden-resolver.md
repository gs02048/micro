...
import (
	...
	"github.com/gs02048/micro/pkg/naming/discovery"
...
etcd默认的全局keyPrefix为micro_etcd,当该keyPrefix与项目中其他keyPrefix冲突时可以通过flag(-etcd.prefix)或者环境配置(ETCD_PREFIX)来指定keyPrefix。
