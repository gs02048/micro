...
使用micro/pkg/cache/memcache包的New方法进行连接池对象的初始化，需要传入上文解析的配置。
...
推荐使用[memcache代码生成器](micro-genmc.md)帮助我们生成memcache操作的相关代码。

以下我们来逐一解析以下micro/pkg/cache/memcache包中提供的常用方法。
...
Flags的相关常量在micro/pkg/cache/memcache包中进行定义，包含编码方式如gob, json, protobuf，和压缩方式gzip。
