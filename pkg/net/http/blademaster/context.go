...
import (
	...
	"github.com/gs02048/micro/pkg/net/http/blademaster/binding"
	"github.com/gs02048/micro/pkg/net/http/blademaster/render"
...
func writeStatusCode(w http.ResponseWriter, ecode int) {
	header := w.Header()
	header.Set("micro-status-code", strconv.FormatInt(int64(ecode), 10))
}
